...
namespace EjercicioTipoParcial.Ejercicio.Tests
{
    public class MarteRoverShould
    {
        [Fact]
        public void AceptarUnEstadoInicial()
        {
            MarteRover marteRover = new MarteRover(0, 0, 'E', new string[] { });

            Assert.Equal("0:0:E", marteRover.ObtenerEstado());
        }
        ...
        {
            MarteRover marteRover = new MarteRover(x, y, direction, new string[] { });

            marteRover.Ejecutar(commands);

            Assert.Equal(expectedFinalState, marteRover.ObtenerEstado());
        }
        ...
        {
            MarteRover marsRover = new MarteRover(0, 0, 'E', new string[] { });
        ...
        {
            MarteRover marsRover = new MarteRover(x, y, direction, obstacles);
